import type { Message, ReferenceTypeId } from "../sdk/clientsdk.ts"

/** what message types to filter on */
...
/** a filter for the resource */
export interface resourceFilter {
	resource: ReferenceTypeId
	enabled: boolean
}

/** returns a full list of resourcenames */
...
/** all the resource that can be listened to  */
...
/** check if this resourse is enabled */
...
/** only return the messages where the filter is enable */
