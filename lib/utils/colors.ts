...
export const ctcol = {
	...
	bgorange: (message: string): string =>
		colors.white.bgRgb24(message, orangedef),
	bgblue: (message: string): string => colors.white.bgRgb24(message, bluedef),
	bgturquoise: (message: string): string =>
		colors.white.bgRgb24(message, turquoisedef),
	bgyellow: (message: string): string =>
		colors.black.bgRgb24(message, yellowdef),
}
